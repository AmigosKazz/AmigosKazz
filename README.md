...
My real passion lies in system design and data structures & algorithms (DSA).
I enjoy designing systems, designing API, choosing architectures, and picking design patterns to solve problems; but I don’t always enjoy writing all the code to implement them.
